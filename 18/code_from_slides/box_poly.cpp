...
int main( ) {
   ...
   std::cout << std::endl << "Access derived class methods directly:" << std::endl;
   print_volume(box1);
   print_volume(tbox1);

   std::cout << std::endl << "Access derived class methods via reference:" << std::endl;
   print_volume_ref(box1);
   print_volume_ref(tbox1);

   std::cout << std::endl << "Access derived class methods via pointers:" << std::endl;
   print_volume_p(&box1);
