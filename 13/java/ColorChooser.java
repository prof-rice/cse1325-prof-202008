...
public class ColorChooser extends JDialog {
    public ColorChooser(Frame frame, String title) {
        ...
        add(save, constraints(0, 5, 1, 2));          // 1x2 button at (0, 5)
    ...
    public GridBagConstraints constraints(int col, int row, int cspan, int rspan) {
    ...
    public static void main( String[] args ) {
        JFrame myApp = new JFrame("GridBagLayout Demo");
        //myApp.setVisible(true);
        
        ColorChooser dialog = new ColorChooser(myApp, "Color Chooser");
