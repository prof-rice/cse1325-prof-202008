...
Canvas::Canvas() : Gtk::DrawingArea(), dirty{false}, click_in_progress{false}, rubber_band{nullptr}, pen_color{Gdk::RGBA("blue")} {
...
bool Canvas::on_motion_notify_event(GdkEventMotion * event) {
    ...
    delete rubber_band;
    rubber_band = new Line{Point{x1, y1}, Point{x2, y2}, pen_color};
    queue_draw();  // initiate screen refresh
